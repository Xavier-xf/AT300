...
run_compile()
{
	...
	if [ "$1" = "313E" ] || [ "$1" = "313e" ];then
		...
		KDIR=/home/wxj/workdir/kocom/anyka-sip-sdk/indoor/AnyCloud37E_SDK_V1.10/os/bd
		CC=/home/wxj/arm-anykav500-linux-uclibcgnueabi/bin/arm-anykav500-linux-uclibcgnueabi- 
		architecture=arm 
		system=Linux 
		platform_soc=PLATFORM_37E
	elif [ "$1" = "37D" ] || [ "$1" = "37d" ];then
		KDIR=/home/leo/anyka_sip/anyka_sip_source_sdk/indoor/platform/kernel/kbd
		CC=/home/leo/anyka_sip/anyka_sip_source_sdk/indoor/gcc/bin/arm-anykav500-linux-uclibcgnueabi-
		architecture=arm 
		system=Linux 
		platform_soc=PLATFORM_37D
