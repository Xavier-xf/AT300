...
#define ATBM_IEEE80211_MIN_ACTION_SIZE offsetof(struct atbm_ieee80211_mgmt, u.action.u)
...
static inline int ieee80211_he_mcs_rate_support(__le16 mcs_map,u8 nss)
{
	u16 mcs_mask = le16_to_cpu(mcs_map) >> ((nss-1)*2);
	return 	(mcs_mask & 0x03) != ATBM_IEEE80211_HE_MCS_NOT_SUPPORTED;
}
static inline u8 ieee80211_he_mcs_operation_rate(__le16 mcs_map,u8 nss)
{
	u16 mcs_mask = le16_to_cpu(mcs_map) >> ((nss-1)*2);
...
enum mac80211_rate_control_flags {
	...
	IEEE80211_TX_RC_SHORT_GI_40M		= BIT(4),
	IEEE80211_TX_RC_40_MHZ_WIDTH		= BIT(5),
	//IEEE80211_TX_RC_DUP_DATA		= BIT(6),
	IEEE80211_TX_RC_SHORT_GI		= BIT(7),
    IEEE80211_TX_RC_HE_MCS			= BIT(6),


	IEEE80211_TX_RC_HT_LDPC			= BIT(8),
	IEEE80211_TX_RC_HE_LDPC			= BIT(9),
	IEEE80211_TX_RC_HE_DCM			= BIT(10),  //set DCM
	IEEE80211_TX_RC_HE_ER			= BIT(11),
	IEEE80211_TX_RC_40M_TO_20M		= BIT(12),  //set main 20M of 40M bandwidth
	IEEE80211_TX_RC_20_MHZ_WIDTH    = BIT(13),  //support 20M of 40M bandwidth.
	IEEE80211_TX_RC_HE_SUPPORT_DCM	= BIT(14),  //support DCM
	IEEE80211_TX_RC_SHORT_GI_20M	= BIT(15)
...
struct ieee80211_tx_info {
	...
	union
	{
		struct {
			...
			u16 tx_rc_flag;
			//u8	tx_dcm_flag;
			//u8	tx_short_gi_flag;  //bit 0,1, bit4 force 20M flag
 ...
 */
static inline const struct atbm_ieee80211_sta_he_cap *
			    ...
			    u8 iftype)
{
	if(sband->band == IEEE80211_BAND_2GHZ){
		...
		if(beamforming_on){
			 atbm_printk_mgmt("beamforming on\n");
					hw->he_cap_2g4->he_cap_elem.phy_cap_info[4] |= (ATBM_IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |\
							ATBM_IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4); /*IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |
							IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4*/
					hw->he_cap_2g4->he_cap_elem.phy_cap_info[6] |= (ATBM_IEEE80211_HE_PHY_CAP6_TRIG_SU_BEAMFORMING_FB |\
						ATBM_IEEE80211_HE_PHY_CAP6_TRIG_MU_BEAMFORMING_PARTIAL_BW_FB|\
						ATBM_IEEE80211_HE_PHY_CAP6_TRIG_CQI_FB);
		}else{
			atbm_printk_mgmt("beamforming off\n");
			hw->he_cap_2g4->he_cap_elem.phy_cap_info[4] &= ~(ATBM_IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |\
							ATBM_IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4); /*IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |
							IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4*/
			hw->he_cap_2g4->he_cap_elem.phy_cap_info[6] &= ~(ATBM_IEEE80211_HE_PHY_CAP6_TRIG_SU_BEAMFORMING_FB |\
		...
		return hw->he_cap_2g4;
	
	}else if(sband->band == IEEE80211_BAND_5GHZ){
		if(beamforming_on){
		 atbm_printk_mgmt(KERN_ALERT "beamforming on\n");
				hw->he_cap_5g->he_cap_elem.phy_cap_info[4] |= (ATBM_IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |\
						ATBM_IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4); /*IEEE80211_HE_PHY_CAP4_SU_BEAMFORMEE |
						IEEE80211_HE_PHY_CAP4_BEAMFORMEE_MAX_STS_UNDER_80MHZ_4*/
				hw->he_cap_5g->he_cap_elem.phy_cap_info[6] |= (ATBM_IEEE80211_HE_PHY_CAP6_TRIG_SU_BEAMFORMING_FB |\
					ATBM_IEEE80211_HE_PHY_CAP6_TRIG_MU_BEAMFORMING_PARTIAL_BW_FB|\
					ATBM_IEEE80211_HE_PHY_CAP6_TRIG_CQI_FB);
	}else
		{
