...
#define IOC_GET_BUF_STATUS	AKPCM_IORn(IOC_NR_GET_BUF_STATUS, struct buf_status)
...
struct buf_status{
    long         supply_zero_bytes; /*当前补了多少byte的0数据*/
    unsigned int valid_data_bytes; /*返回当前buffer剩余数据长度*/
};
