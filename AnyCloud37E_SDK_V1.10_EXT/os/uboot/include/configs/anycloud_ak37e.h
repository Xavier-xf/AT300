...
#ifndef __ANYCLOUD_AK37E_H
#define __ANYCLOUD_AK37E_H

#include "ak_board.h"


#define CONFIG_37_E_CODE 
...
/*
* select for eth interface for double net port
*/
#ifdef AK_DOUBLE_ETH_SUPPORT
// #define CONFIG_RMII_ETH0	1
// #define CONFIG_RMII_ETH1	1
...
#define CONFIG_LCD_BACKLIGHT_GPIO 82
#endif
...
#define TF_POWER_ON_GPIO	36
#define TF_DET_GPIO		    35

#define NET_RESET_GPIO		85
#define NET1_RESET_GPIO		86

/*mipi*/
#define LCD_RGB_IF	        1
#define LCD_RESET_PIN	    34
...
/* jpy23106 */
#define PANEL_4_WIDTH                   320
#define PANEL_4_HEIGHT                  240
#define PANEL_4_PCLK_DIV                1
#define PANEL_4_DATA_WIDTH              0
#define PANEL_4_COLOR_MODE              1
#define PANEL_4_A0_POL                  1
#define PANEL_4_WR_CYCLE                16
#define PANEL_4_WR_LOW                  4
#define PANEL_4_DIRECTION               0
...
#define CONFIG_BKENV_OFFSET  		(0x80000)	
#define CONFIG_BKENV_SIZE  			(4*1024)
#define CONFIG_ENV_PARTITION_SIZE  	(128*1024*2) 
...
#define CONFIG_DEFAULT_MTDPARTS \
    ...
    "128K@0x60000(DTB),256K@0x80000(UBOOT),1664K@0xC0000(KERNEL),384K@0x260000(LOGO),"\
    "10240K@0x2C0000(ROOTFS),10240K@0xCC0000(CONFIG),12288K@0x16C0000(APP)\0"\
...
#define CONFIG_BKENV_SIZE  			(4*1024)
/*#define CONFIG_DTB_OFFSET  			(0x39000)*/
/*#define CONFIG_DTB_SIZE  			(64*1024)*/
