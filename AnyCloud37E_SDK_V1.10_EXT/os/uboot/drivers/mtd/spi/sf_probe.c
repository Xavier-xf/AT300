...
static 	struct flash_status_reg status_reg_list[] = {
		...
		/* NM25Q128EVB */
		 ...
		 /*gd25Q256 */
		 {
			.jedec_id = 0xc84019,	.ext_id = 0,
			.b_wip = 0, .b_wel = 1, .b_bp0 = 2, .b_bp1 = 3,
			.b_bp2 = 4, .b_bp3 = 5, .b_qe = 9,
			.read_sr = spi_flash_cmd_read_status,
			.write_sr = spi_flash_cmd_write_status,
		},
		...
		/* MX25L25645G */
		{
			.jedec_id = 0xc22019,	.ext_id = 0,
			.b_wip = 0, .b_wel = 1, .b_bp0 = 2, .b_bp1 = 3,
			.b_bp2 = 4, .b_bp3 = 5, .b_qe = 6,
			.read_sr = spi_flash_cmd_read_status,
			.write_sr = spi_flash_cmd_write_status,
		},
...
static const struct spi_flash_params spi_flash_params_table[] = {
	...
	{ "kh25l64", 0xc22017, 0, 64 * 1024, 128, SECT_4K | SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},//check ok
	{ "kh25l128", 0xc22018, 0, 64 * 1024, 256, SECT_4K | SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},//check ok
	{ "mx25l12855e", 0xc22618, 0, 64 * 1024, 256, SECT_4K | SFLAG_DUAL_READ, 0,},
	{ "MX25L25645G", 0xc22019, 0, 64 * 1024, 512, SECT_4K, 0,},
	...
	{ "w25q256", 0xef4019, 0, 64 * 1024, 512, SFLAG_ADDR_4B|SECT_4K|SFLAG_COM_STATUS2|SFLAG_COM_STATUS3, 0,},
	...
	{ "gd25q128", 0xc84018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},
    ...
    { "XM25QH256C", 0x204019, 0, 64 * 1024, 512, SFLAG_ADDR_4B|SECT_4K|SFLAG_COM_STATUS2|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},
   ...
   { "BY25Q128ASSIG",  0x684018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
	...
	//ds
   { "DS-FM25Q64A", 0xf83217, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
   ...
   { "XT25F128B",  0x0b4018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
    ...
    { "GM25Q64A", 0x1c4017, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS2|SFLAG_COM_STATUS3|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},

    { "GM25Q128A", 0x1c4018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_COM_STATUS3|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},

    { "ME25L64E", 0xd84017, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
    { "ME25L128C", 0xd84018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},

    { "PY25Q64HA", 0x852017, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
    { "PY25Q128HA", 0x852018, 0, 64 * 1024, 256, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_DUAL_IO_READ|SFLAG_QUAD_IO_READ|SFLAG_QUAD_WRITE,},
		...
		unsigned int max_hz, unsigned int spi_mode)
{
	...
	/* Setup spi_slave */
	spi = spi_setup_slave(bus, cs, 50000000, spi_mode);
	if (!spi) {
    ...
    if ((jedec != 0x1c4018) && (jedec != 0x1c4017)) {
        spi_free_slave(spi);
