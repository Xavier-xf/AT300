...
#else
	i = TF_MCI_IDEX;
	g_power_on_pin = TF_POWER_ON_GPIO;
	mmc_cd_if.mmc_plug_mod = CD_CLK_MODE;
	mmc_cd_if.mmc_plug_gpio_index = TF_DET_GPIO;

	printf("g_power_on_pin:%d\n", g_power_on_pin);
#endif
