...
/*
* AK3760D include 81 gpio(GPI0[3:1] + GP10[15:10] GP10[19:20] + GP10[28:23] + gpio[49:31]
* GPIO[98:67] + GP1[0] + GP1[13:2]}
* GPI[0] Mapping to GPIO[122]
* GPI[13:2] Mapping to GPIO[120:109]
*/
...
#define AK_GPIO_84			AK_GPIO_GROUP3_NO(20)
...
#define AK_GPIO_93			AK_GPIO_GROUP3_NO(29)
#define AK_GPIO_94			AK_GPIO_GROUP3_NO(30)
#define AK_GPIO_95			AK_GPIO_GROUP3_NO(31)

#define AK_GPIO_96			AK_GPIO_GROUP4_NO(0)
#define AK_GPIO_97			AK_GPIO_GROUP4_NO(1)
#define AK_GPIO_98			AK_GPIO_GROUP4_NO(2)
#define AK_GPIO_99			AK_GPIO_GROUP4_NO(3)
#define AK_GPIO_100			AK_GPIO_GROUP4_NO(4)
#define AK_GPIO_101			AK_GPIO_GROUP4_NO(5)
#define AK_GPIO_102			AK_GPIO_GROUP4_NO(6)
#define AK_GPIO_103			AK_GPIO_GROUP4_NO(7)
#define AK_GPIO_104			AK_GPIO_GROUP4_NO(8)
#define AK_GPIO_105			AK_GPIO_GROUP4_NO(9)
#define AK_GPIO_106			AK_GPIO_GROUP4_NO(10)
#define AK_GPIO_107			AK_GPIO_GROUP4_NO(11)
#define AK_GPIO_108			AK_GPIO_GROUP4_NO(12)
#define AK_GPIO_109			AK_GPIO_GROUP4_NO(13)
#define AK_GPIO_110			AK_GPIO_GROUP4_NO(14)
#define AK_GPIO_111			AK_GPIO_GROUP4_NO(15)
#define AK_GPIO_112			AK_GPIO_GROUP4_NO(16)
#define AK_GPIO_113			AK_GPIO_GROUP4_NO(17)
#define AK_GPIO_114			AK_GPIO_GROUP4_NO(18)
#define AK_GPIO_115			AK_GPIO_GROUP4_NO(19)
#define AK_GPIO_116			AK_GPIO_GROUP4_NO(20)
#define AK_GPIO_117			AK_GPIO_GROUP4_NO(21)
#define AK_GPIO_118			AK_GPIO_GROUP4_NO(22)
#define AK_GPIO_119			AK_GPIO_GROUP4_NO(23)
#define AK_GPIO_120			AK_GPIO_GROUP4_NO(24)
#define AK_GPIO_121			AK_GPIO_GROUP4_NO(25)
#define AK_GPIO_122			AK_GPIO_GROUP4_NO(26)
