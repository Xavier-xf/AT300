...
enum akspi_cs_num {	
	...
	AKSPI_ONCHIP_CS1,	/*on chip control cs index*/
#endif
	/*AKSPI_CS1,*/
	/*AKSPI_CS2,*/
	AKSPI_CS_NUM, 		
...
#define AK_SPICON_CLKDIV	(0xFF<<8)
...
#define AK_SPISTA_TIMEOUT	(1<<13) // 
#define AK_SPISTA_THRESHOLD	(1<<12) //threshold 阀值，开端
#define AK_SPISTA_CSEND		(1<<11)	//cs end. 0: cs is low; 1: cs is high
#define AK_SPISTA_LESSWORD	(1<<10)	//<1word (4bytes)
...
#define AK_SPIINT_TIMEOUT	(1<<13)
#define AK_SPIINT_THRESHOLD	(1<<12)
#define AK_SPIINT_CSEND 	(1<<11)
#define AK_SPIINT_LESSWORD	(1<<10)
