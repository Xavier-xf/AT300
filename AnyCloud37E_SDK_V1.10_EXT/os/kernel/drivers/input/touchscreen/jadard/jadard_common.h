...
#define JADARD_DRIVER_VER        "02.0A" /* MAJOR_VER.MINOR_VER */
...
struct jadard_ic_data {
	...
	uint32_t JD_SECOND_ADDR_OFFSET;
	uint32_t JD_BOTH_ADDR_OFFSET;
	bool     JD_DISABLE_MASTER_TO_SECOND;
};
...
#ifdef CONFIG_JD_HID
extern int jadard_hid_init(void);
extern void jadard_hid_exit(void);
void jadard_hid_work(struct jadard_ts_data *ts);
#endif
