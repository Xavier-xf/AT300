...
#define JADARD_PROC_REGISTER_APK_FILE "register_apk"
...
static struct proc_dir_entry *jadard_proc_register_apk_file;
...
#define JD_SECOND_FW_DUMP_FILE "/sdcard/JD_SECOND_FW_Dump.bin"
...
static uint16_t    reg_read_len;
static uint8_t     reg_cmd_apk[4];
static uint8_t     reg_cmd_apk_len;
static uint16_t    reg_read_apk_len;
