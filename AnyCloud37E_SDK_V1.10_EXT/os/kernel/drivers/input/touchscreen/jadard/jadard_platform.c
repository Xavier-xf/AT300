...
#if defined(JD_DEV_PM) || !defined(JD_RESUME_NOT_WAIT_FW)
...
void jadard_drm_notifier_callback(enum panel_event_notifier_tag tag,
...
static int jadard_chip_common_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
