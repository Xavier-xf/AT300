# AnyCloud37E SDK V1.10 正式版 更改说明

支持AK37E芯片SDK V1.10正式版本，发布时间2023年9月。
主要修改点如下：

## 内核

- 【bug修复】修复内核bluetooth内存泄漏问题。
- 【bug修复】修复XT26G02C型号nand的ECC检验方式。
- 【bug修复】修复AIR724UG 4G模块的urb transfer_flags设置错误问题。
- 【bug修复】修复ctrl+c强行退出时watchdog不生效的问题。
- 【代码优化】兼容XT26G01C型号nandflash的ECC检测。
- 【新增功能】支持spi slave功能。
- 【新增功能】新增元器件支持，详见《关键元器件支持列表》文档。

## 驱动

- 【bug修复】修复非自动协商100M半双工时，有线网络配置不正确问题。
- 【bug修复】修复usb传输出现l2 dma未完成错误问题。
- 【bug修复】修复煲机出现读取设备描述符报错的问题。
- 【bug修复】修复网络风暴导致eth卡住的问题。
- 【bug修复】修复以太网不插网线卡住时间过长的问题。
- 【bug修复】修复uvc二次采集无法出图问题。
- 【bug修复】修复mipi屏休眠后无法唤醒的问题。
- 【代码优化】修改PCM的IOC_GET_BUF_STATUS参数为struct buf_status。
- 【代码优化】image_capture增加奇偶场合并，以及参数用于关闭奇偶场融合。
- 【代码优化】优化以太网驱动的CPU占用率。
- 【新增功能】支持usb host camera。
- 【新增功能】新增元器件支持，详见《关键元器件支持列表》文档。

## Bootloader

- 【代码优化】修复去掉网络后编译报错的问题。
- 【代码优化】优化uboot阶段logo显示流程。
- 【代码优化】兼容XT26G01C型号nandflash的ECC检测。
- 【bug修复】修复XT26G02C型号nand的ECC检验方式。
- 【新增功能】新增元器件支持，详见《关键元器件支持列表》文档。
...
- 【bug修复】修复多次开关AO后，AEC开启异常的问题。
- 【bug修复】修复VDEC PP模块argb8888解码后，BLIT贴图全透明的问题。
- 【bug修复】修复VO模块在单buff模式下刷新失败的问题。
- 【bug修复】修复argb8888在旋转的时候透明色不能过滤问题。
- 【代码优化】AnyCloud37E平台视频编码只支持jpeg格式，宽度16对齐即可。
- 【代码优化】localtime替换成localtime_r避免线程重入。
- 【新增功能】MUX模块新增ak_mux_pause、ak_mux_continue、ak_mux_fix_file和ak_mux_get_status接口及相应数据结构。
- 【新增功能】VDEC模块新增ak_vdec_get_frame_info、ak_vdec_mp_action接口及相应数据结构。
- 【新增功能】VO模块支持mpu屏幕刷新。
- 【新增功能】VDEC模块新增对irq线程的超时退出时间进行配置。
- 【新增功能】VDEC模块新增rlc配置选项。
- 【新增功能】AO模块ak_ao_get_buf_status新增获取参数，更新ak_dev_buf_status结构体。

## 工具

- 【代码优化】Anyka_Audio_Tuning_Tool音频调试工具更新。
- 【代码优化】Anyka_USB_Burn_Tool工具更新。
- 【代码优化】Anyka_Uart_Burn_Tool工具更新。
- 【bug修复】producer更新。修复FLASH写时使用mode 0，读时使用mode 1造成FLASH烧写失败的问题；修复在烧录boot数据时拔usb会异常的问题；修复回读整个flash会失败以及升级会失败的问题；修复分区减掉坏块后剩余空间不足的情况下烧录也没有报错的问题；修复uboot 升级失败问题等。





# AnyCloud37E SDK V1.09 正式版 更改说明

发布时间2022年9月14日。SDK无修改。
