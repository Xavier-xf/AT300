...
static inline lv_align_t lv_obj_get_style_bg_img_align(const struct _lv_obj_t* obj, uint32_t part)
{
    lv_style_value_t v = lv_obj_get_style_prop(obj, part, LV_STYLE_BG_IMG_ALIGN);
    return (lv_align_t)v.num;
}
...
void lv_obj_set_style_bg_img_align(struct _lv_obj_t* obj, lv_align_t value, lv_style_selector_t selector);
