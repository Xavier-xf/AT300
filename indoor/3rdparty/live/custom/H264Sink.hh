#ifndef _H264_SINK_HH_
#define _H264_SINK_HH_
...
{
public:
    static H264Sink *createNew(UsageEnvironment &env, char const *fileName,
...
protected:
    H264Sink(UsageEnvironment &env, FILE *fid, unsigned bufferSize,
