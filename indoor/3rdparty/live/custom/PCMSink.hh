#ifndef _PCM_SINK_HH_
#define _PCM_SINK_HH_

#include "MediaSink.hh"

class PCMSink : public MediaSink
{
public:
    static PCMSink *createNew(UsageEnvironment &env, char const *fileName,
                               unsigned bufferSize = 512 * 1024,
...
protected:
    PCMSink(UsageEnvironment &env, FILE *fid, unsigned bufferSize,
